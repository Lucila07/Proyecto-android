...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        servicioUsuarios= new ServicioUsuariosHttp();
        //lo de google
    ...
    /**
     * es el metodo que chequea los datos de login
     *
     *
     */
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(email)) {
            mEmailView.setError("Se debe ingresar un mail");
            focusView = mEmailView;
            cancel = true;
        } else if (!isEmailValid(email)) {
            mEmailView.setError("El mail es invalido");
            focusView = mEmailView;
            cancel = true;
        }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
           ...
           return  servicioUsuarios.validarUsuario(mEmail,mPassword);
        ...
        /**
         * carga el main, cuando el login fue exitoso
         * */
